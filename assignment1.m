...
%
% Answer: Removes items from the workspace, which frees up system memory 
%
...
%
% Answer: - for statements loop a specific number of times, and keep track 
...
%
% Answer: NaN stands for "not a number". An example that would give NaN is
% 0/0.
...
base1 = 2;
% The top of the trapeziod has a value of 2.
base2 = 5;
% The bottom of the trapezoid parallel to the top has a value of 5.
height = 7;
% The height of the trapezoid or he distance between the top and bottom of
% the trapezoid has a value of 7.
trapArea = (base1 + base2)/2*height;
% The Area of the trapezoid equals base1 of the trapezoid + base2 trapezoid,
% divided by 2 and multiplied by the height of the trapezoid.
